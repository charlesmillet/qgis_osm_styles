...
<qgis version="2.8.1-Wien" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{f97404bd-5eac-432b-b8ca-4d6e27327933}">
      <rule scalemaxdenom="250000" filter=" &quot;place&quot;  in ('village', 'state' , 'region' , 'city' , 'town' )" key="{350f16bf-6f8a-443d-b045-87712ed7b802}" symbol="0" scalemindenom="25000" label="25 000 - 250 000"/>
      <rule scalemaxdenom="25000" filter=" &quot;place&quot;  in ('hamlet', 'village', 'state' , 'region' , 'city' , 'town' )" key="{3f29b4ca-2a1e-4699-acdb-9120080d6e31}" symbol="1" scalemindenom="1" label="0 - 25 000"/>
    </rules>
    <symbols>
  ...
  <customproperties>
    ...
    <property key="labeling/dataDefined/FontCase" value="1~~1~~CASE WHEN &quot;place&quot; IN ('village', 'city', 'town') THEN 'Upper' ELSE 'NoChange' END~~"/>
    <property key="labeling/dataDefined/ScaleVisibility" value="1~~1~~CASE WHEN &quot;place&quot; in ( 'city','town' , 'village' , 'suburb' ) &#xa;THEN 0&#xa;ELSE 1&#xa;END~~"/>
    <property key="labeling/dataDefined/Size" value="1~~1~~CASE WHEN &quot;place&quot; IN ('village', 'city', 'town') THEN 9 ELSE 7 END~~"/>

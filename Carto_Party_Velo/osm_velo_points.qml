...
<qgis version="2.8.1-Wien" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="5" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{d53140b1-78e5-4465-a686-960f08266003}">
      <rule key="{06af4e0d-f09b-4a2c-a912-2eeb90e3c3b2}" label="Adresses">
        <rule scalemaxdenom="6250" filter="&quot;other_tags&quot; LIKE '%&quot;addr:housenumber&quot;%'" key="{a4868fab-b198-493d-b0f1-f0b617dd5fee}" symbol="0" scalemindenom="2500" label="2 500 - 6 250"/>
        <rule scalemaxdenom="2500" filter="&quot;other_tags&quot; LIKE '%&quot;addr:housenumber&quot;%'" key="{c4f8524c-5ca2-4001-b807-81834dbf929f}" symbol="1" scalemindenom="1" label="0 - 2 500"/>
      </rule>
      <rule filter="&quot;other_tags&quot; LIKE '%&quot;bicycle_parking&quot;%'" key="{d4c92d9e-b125-4357-a8cf-d427fd1090f8}" symbol="2" label="Parking vélo"/>
    </rules>
    <symbols>
      <symbol alpha="1" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="106,237,213,255"/>
  ...
  <customproperties>
    ...
    <property key="labeling/dataDefined/Color" value="1~~1~~CASE &#xa;WHEN (&quot;other_tags&quot; LIKE '%&quot;bicycle_parking&quot;%') THEN  color_rgb( 255,0,0)&#xa;END~~"/>
    ...
    <property key="labeling/fieldName" value="CASE&#xa;WHEN (&quot;other_tags&quot; LIKE '%&quot;addr:housenumber&quot;%') THEN left (&#xa;      substr(&#xa;         &quot;other_tags&quot;,&#xa;         strpos(&quot;other_tags&quot; ,'&quot;addr:housenumber&quot;=>&quot;')+22,&#xa;         6&#xa;      ),&#xa;      strpos(&#xa;         substr(&#xa;            &quot;other_tags&quot;,&#xa;            strpos(&quot;other_tags&quot; ,'&quot;addr:housenumber&quot;=>&quot;')+22,&#xa;            6&#xa;         ),&#xa;        '&quot;'&#xa;      )&#xa;   )&#xa;   WHEN (&quot;other_tags&quot; LIKE '%&quot;bicycle_parking&quot;%') THEN left (&#xa;      substr(&#xa;         &quot;other_tags&quot;,&#xa;         strpos(&quot;other_tags&quot; ,'&quot;capacity&quot;=>&quot;')+14,&#xa;         6&#xa;      ),&#xa;      strpos(&#xa;         substr(&#xa;            &quot;other_tags&quot;,&#xa;            strpos(&quot;other_tags&quot; ,'&quot;capacity&quot;=>&quot;')+14,&#xa;            6&#xa;         ),&#xa;        '&quot;'&#xa;      )&#xa;   )&#xa;END"/>

...
<qgis version="2.8.1-Wien" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{5ec24f76-15ad-462d-b1c0-be17982ab3a5}">
      <rule filter="&quot;landuse&quot; IN ('forest','grass') or &quot;leisure&quot; = 'park'" key="{5e2bc0e4-cd43-4959-bf1f-53edc09229bc}" symbol="0" label="Forêt &amp; parc"/>
      <rule filter=" &quot;natural&quot;   IN (  'wetland' , 'wood'  ) " key="{fe597c2e-425d-4523-bf17-23a2bd409ee6}" symbol="1" label="Marais"/>
      <rule filter=" &quot;landuse&quot;  =  'farm'" key="{45f30d1a-c3bd-48d1-b9ff-20d1b8fbbb12}" symbol="2" label="Culture"/>
      <rule filter="&quot;landuse&quot; = 'meadow'" key="{b59b6d3c-c357-479d-bbbf-a6c1567676ba}" symbol="3" label="Prairie"/>
      <rule filter=" &quot;landuse&quot;  =  'vineyard' " key="{588e3112-cb4c-4780-a129-6343bbd0ea01}" symbol="4" label="Vigne"/>
      <rule filter=" &quot;aeroway&quot; IS NOT NULL OR &quot;landuse&quot; in ('industrial', 'brownfield','retail','railway' )" key="{111a1283-1d3d-4b1f-8fee-75c50d67d44c}" symbol="5" label="Industrie"/>
      <rule filter="&quot;landuse&quot; = 'residential' OR &quot;landuse&quot; = 'farmyard' " key="{98301e60-3bc9-4b54-9373-bd9101cfdce5}" symbol="6" label="Residentiel"/>
      <rule filter=" &quot;place&quot;  =  'island' " key="{87fcf55b-5939-46a1-b045-82ac31a9dd03}" symbol="7" label="Isles"/>
      <rule scalemaxdenom="15000" filter=" &quot;building&quot; is not null" key="{05f7e3aa-944d-4ac3-968b-1e219fab8999}" symbol="8" scalemindenom="1" label="Bâtiment">
        <rule filter="&quot;building&quot; IN ( 'church','cathedral')" key="{9f6fa53b-d8be-4ed9-83a4-0a65f1df760b}" symbol="9" label="Église"/>
      </rule>
      <rule filter="&quot;natural&quot; = 'water' OR &quot;other_tags&quot; LIKE '%&quot;water&quot;%' OR &quot;other_tags&quot; LIKE '%&quot;waterway&quot;=>&quot;riverbank&quot;%' OR  &quot;waterway&quot;  LIKE  'riverbank' " key="{af8205a0-1a02-49d9-aaa8-41e04dc2427d}" label="Eau">
        <rule filter="$area > 0.0000005" key="{1f8ebf6b-88b8-4702-b20e-f912fb499e97}" symbol="10" label="Grande surface"/>
        <rule scalemaxdenom="10000" filter="$area  &lt;=  0.0000005" key="{88e53c02-7c4c-456f-87c3-ee5c5ea4f2aa}" symbol="11" scalemindenom="1" label="Petite surface"/>
        <rule checkstate="0" key="{19ae2ca6-cbf4-469b-a341-d1f2772ed12e}" symbol="12" label="water"/>
      </rule>
    </rules>
    <symbols>
      ...
      <symbol alpha="1" type="fill" name="10">
        <layer pass="4" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="color" v="200,227,255,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol alpha="1" type="fill" name="8">
        <layer pass="6" class="SimpleFill" locked="0">
          <prop k="border_width_map_unit_scale" v="0,0"/>
          <prop k="color" v="227,216,221,255"/>
          <prop k="joinstyle" v="miter"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="outline_color" v="227,216,221,255"/>
          <prop k="outline_style" v="solid"/>
